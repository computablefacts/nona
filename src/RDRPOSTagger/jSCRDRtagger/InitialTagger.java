...
public class InitialTagger {
  ...
  private static final Pattern JJ2 =
      Pattern.compile("(^[Ii]nter.*)|(^[nN]on.*)|(^[Dd]is.*)|(^[Aa]nti.*)");
  private static final Pattern JJ3 =
      Pattern.compile("(.*ful$)|(.*ous$)|(.*ble$)|(.*ic$)|(.*ive$)|(.*est$)|(.*able$)|(.*al$)");
  private static final Pattern NN =
      Pattern.compile("(.*ness$)|(.*ment$)|(.*ship$)|(^[Ee]x-.*)|(^[Ss]elf-.*)");
  ...
  public static List<WordTag> InitTagger4Sentence(HashMap<String, String> DICT, String sentence) {
  ...
  public static List<WordTag> EnInitTagger4Sentence(HashMap<String, String> DICT, String sentence) {
    List<WordTag> wordtags = new ArrayList<WordTag>();
    ...
    for (String word : sentence.split("\\s+")) {
      ...
      if (DICT.containsKey(word))
        ...
        if (JJ1.matcher(word).find())
          ...
          tag = "NN";
        else if (NNS.matcher(word).find() && Character.isLowerCase(word.charAt(0)))
          tag = "NNS";
  ...
  public static void EnInitTagger4Corpus(HashMap<String, String> DICT, String inputRawFilePath,
      String outFilePath) throws IOException {
    BufferedReader buffer = new BufferedReader(
        new InputStreamReader(new FileInputStream(new File(inputRawFilePath)), "UTF-8"));

    BufferedWriter bw =
        new BufferedWriter(new OutputStreamWriter(new FileOutputStream(outFilePath), "UTF-8"));
  ...
  public static List<WordTag> VnInitTagger4Sentence(HashMap<String, String> DICT, String sentence) {
    List<WordTag> wordtags = new ArrayList<WordTag>();
  ...
  public static void VnInitTagger4Corpus(HashMap<String, String> DICT, String inputRawFilePath,
      String outFilePath) throws IOException {
    BufferedReader buffer = new BufferedReader(
        new InputStreamReader(new FileInputStream(new File(inputRawFilePath)), "UTF-8"));
